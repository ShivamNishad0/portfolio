...
function PortfolioProjects() {
	...
	const projects = [
		...
		},
		{
			...
			description:
			"A Book Recommendation System is a smart application designed to suggest books to users based on their preferences, reading history, or popular trends. Using Python as the backend programming language and Flask as the web framework, developers can quickly build a lightweight and efficient recommendation engine.",			
			image: "/bookRecommendation.png",
