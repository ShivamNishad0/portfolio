	...
	const contactInfo = [
		{
			...
			title: "Email",
			value: "sn.shivamni@gmail.com",
			link: "mailto:sn.shivamni@gmail.com",
		},
		{
			icon: <Phone className='w-5 h-5' />,
			title: "Phone",
			value: "+91 8887756715",
			link: "tel:+91 8887756715",
		},
		{
	...
	return (
		<section
			...
			<div className='max-w-3xl w-full xl:max-w-270  mx-auto px-4 sm:px-6 lg:px-8'>
				...
				<div className='flex flex-col justify-center items-stretch md:flex-row gap-8 lg:gap-12 w-full'>
					{/* Contact Info */}
					...
					{/* Contact Form */}
					<ScrollReveal delay={400} className="w-full md:w-1/2">
						<Card className='backdrop-blur-sm rounded-2xl border-gray-200 dark:border-gray-800 border bg-transparent text-gray-800 dark:text-gray-200 h-full'>
